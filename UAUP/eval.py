...
if __name__=="__main__":
    ...
    test_types = ["color","font","resize"]
    iter_eval = [25,30,40,50]
    model_name = "CRAFT"
            ...
            for test_type in test_types:
                ...
                if test_type == "resize":
                    for d1 in os.listdir(temp_gt_path):
                        ...
                        logINFO("test_type:{} resize: {} MUI:{} R:{:.4f} P:{:.4f} F:{:.4f} AVGPERT:{:.4f}".format(test_type,d1,iter,R,P,F,pert), log_file)
                    ...
                    for k,v in dict.items():
                        logINFO("test_type:{}-{} resize: {} MUI:{} R:{:.4f} P:{:.4f} F:{:.4f} AVGPERT:{:.4f}".
