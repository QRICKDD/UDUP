...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        temp_model_url=os.path.join(abspath,"model_PAN/pretrained/resnet18-imagenet.pth")
        model.load_state_dict(torch.load(temp_model_url, map_location=None), strict=False)
    return model
